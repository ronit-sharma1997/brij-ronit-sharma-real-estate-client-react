  ...
  return (
    <div className="flex flex-wrap">
      ...
      <div className="w-full lg:w-1/2">
        <img className="w-full h-full" src="common/father-son.jpg" />
      </div>
      {/*Right Side - Profile Description*/}
      <div className="w-full lg:w-1/2 relative my-auto pt-10">
        ...
        <div className="flex flex-wrap w-4/5 xl:w-1/2 mx-auto pt-10 lg:pt-0">
          <div className="w-full font-playfair-display tracking-wide text-2xl md:text-4xl">Brij & Ronit Sharma</div>
          <div className="w-full font-roboto-serif tracking-wide text-xl md:text-2xl uppercase mt-3">
            Realtor Associates
          </div>
          <div className="w-full font-roboto-serif tracking-wide text-lg md:text-xl">ronitsharma.realtor@gmail.com</div>
          <div className="w-full font-roboto-serif tracking-wide text-lg md:text-xl">+1 (732)-395-1368</div>
          <div className="inline-flex mt-3">
            <FontAwesomeIcon className="w-8 h-8 mr-3" icon={faSquareFacebook} />
            <FontAwesomeIcon className="w-8 h-8" icon={faSquareInstagram} />
          </div>
          <div className="w-full font-roboto-serif tracking-wide text-base lg:text-xl mt-3">
          ...
          <div className="w-full mt-8 mb-8">
            <button className="w-full md:w-36 rounded-none border-2 px-2 py-4 border-black font-roboto-serif text-sm uppercase text-black hover:bg-black hover:cursor-pointer hover:text-white transition-[all] duration-700 mr-9">
              View Profile
            </button>
            <button className="w-full md:w-36 mt-4 rounded-none border-2 px-2 py-4 border-black font-roboto-serif text-sm uppercase text-white bg-black hover:bg-white hover:cursor-pointer hover:text-black transition-[all] duration-700 mr-9 z-10">
              Contact Us
            </button>
          </div>
        </div>
