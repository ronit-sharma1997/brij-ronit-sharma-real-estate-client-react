  ...
  return (
    <div className="flex flex-wrap justify-between px-5 py-5 md:px-10 md:py-5">
      ...
      <div className="hidden min-[900px]:flex mx-auto mt-5 xl:mt-0 xl:mx-0">
        <div className="font-roboto-serif text-black uppercase font-medium text-base my-auto mx-7 hover:underline hover:cursor-pointer">
          Property Search
        </div>
        <div className="font-roboto-serif text-black uppercase font-medium text-base my-auto mx-7 hover:underline hover:cursor-pointer">
          About Us
        ...
        <div className="font-roboto-serif text-black uppercase font-medium text-base my-auto ml-7 hover:underline hover:cursor-pointer">
          Home Valuation
        </div>
      </div>
      ...
      <div className="flex min-[900px]:hidden">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-10 h-10 text-black my-auto hover:bg-gray-100 hover:cursor-pointer"
        >
