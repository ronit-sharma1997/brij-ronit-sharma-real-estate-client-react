  ...
  return (
    <div className="bg-white mx-auto" style={{ flex: '1 0 100%' }}>
      <div className="flex flex-wrap px-3 py-4">
        <div className="w-1/3 xl:w-1/4 mx-auto">
          <img className="rounded-full mx-auto mt-5" src="common/avatar.jfif" alt="Client" />
        </div>
        <div className="w-full xl:w-3/4 px-3">
          <div className="flex flex-wrap">
            ...
            <div className="w-full font-roboto-serif text-center md:text-left font-semibold text-base lg:text-2xl uppercase md:mt-5">
              {testimonialTitle}
            </div>
